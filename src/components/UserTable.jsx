...
const UserTable = ({ users }) => {
  ...
  const deleteMutation = useMutation((id) => axios.delete(`http://localhost:3004/users/${id}`),
    {
      onSuccess: () => {
  ...
  return (
    <React.Fragment>
      ...
      <div className="flex items-center justify-between mb-4">
        <Link
          to="/user/create"
          className="px-4 py-1 font-semibold text-teal-900 border-2 border-teal-700 rounded hover:bg-teal-800 hover:text-white"
        >
          Create User
        </Link>
